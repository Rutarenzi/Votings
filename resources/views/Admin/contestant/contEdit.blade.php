        ...
        <section class="main">
            ...
            <div class="container">
                ...
                <div class="formBranch" id="formTable">
                    <form action={{ route('updateCont',['id'=>$contestant->id])}} method="Post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                         <label for="brancName"> Name</label><br><br>
                         <input type="text" name="Name" placeholder="name of the Event" id="branchName" value="{{$contestant->Name}}"><br>
                         @error('Name')
